...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        patch_theta = patch_theta-repmat(patch_angle_offset,size(patch_theta));
        fprintf('patch_theta %d ',patch_theta)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                              %
%                              END OF YOUR CODE                                %
%                                                                              %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        % pixelsPerHistogram x pixelsPerHistogram. 
         row_num=repmat([pixelsPerHistogram],1,num_histograms);
         theta_cells=mat2cell(patch_theta,row_num,row_num);
         mag_cells=mat2cell(patch_mag,row_num,row_num);
        ...
        % the histograms into a single feature vector of length 128.
         ...
         for j=1:num_histograms
             for k=0:num_histograms-1
             histogram=ComputeGradientHistogram(num_angles, mag_cells{k*num_histograms+j}, theta_cells{k*num_histograms+j});
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [rows,cols]=size(gradient_angles);
    for i=1:rows
        for j=1:cols
        histogram(ceil(gradient_angles(i,j)/angle_step))=histogram(ceil(gradient_angles(i,j)/angle_step))+gradient_magnitudes(i,j);
        end
    end
